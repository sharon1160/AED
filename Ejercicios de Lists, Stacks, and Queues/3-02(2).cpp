...
class ListaDoble
{
    ...
    public:
        ...
        void swap()
        {
            ...
            Nodo<T> *adyacente1;
            Nodo<T> *adyacente2;
            adyacente1= partida->getSiguiente();
            adyacente2 = adyacente1->getSiguiente();
            
            adyacente1->setSiguiente(adyacente2->getSiguiente());
            adyacente1->setAnterior(adyacente2);
            partida->setSiguiente(adyacente2);
            adyacente2->setSiguiente(adyacente1);
            adyacente2->setAnterior(partida);
